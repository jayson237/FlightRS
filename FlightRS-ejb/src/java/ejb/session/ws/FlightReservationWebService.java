...
public class FlightReservationWebService {
    ...
    @WebMethod(operationName = "searchAllFlight")
    public List<FlightSchedule> searchAllFlight(@WebParam(name = "origin") String origin,
    ...
    @WebMethod(operationName = "getConnectingFlightSchedules")
    public List<MyPair> getConnectingFlightSchedules(@WebParam(name = "origin") String origin,
            @WebParam(name = "destination") String destination,
            @WebParam(name = "date") String date,
    ...
    public SeatInventory getSeatInventory(@WebParam(name = "flightscheduleentity") FlightSchedule flightscheduleentity,
            @WebParam(name = "cabinclasstype") CabinClassType cabinclasstype) throws
            FlightScheduleNotFoundException,
    ...
    public boolean isBooked(@WebParam(name = "seatinventoryentity") SeatInventory seatinventoryentity,
    ...
    public List<Transaction> retrieveTransactionsByCustomerId(@WebParam(name = "userid") long userid) {
